...
import com.nmhung.annotations.GeneratedValue;
...
public class BuildingEntity extends BaseEntity{
	...
	public String getTimeErent() {
		return timeErent;
	}

	public void setTimeErent(String timeErent) {
		this.timeErent = timeErent;
	}
